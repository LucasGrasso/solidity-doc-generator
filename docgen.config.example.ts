  ...
  plugins: [
    {
      ...
      hooks: {
        ...
        onItem: async (item: any, context: any) => {
        ...
        onFilter: async (items: any[], context: any) => {
        ...
        onWrite: async (files: any[], context: any) => {
          // Example: Add header comment to every file
          return files.map((f: any) => ({
            ...f,
            content: "<!-- Auto-generated by solidity-docgen -->\n" + f.content,
          }));
        },

        // Runs after all files are written
        onFinish: async (files: any[], context: any) => {
